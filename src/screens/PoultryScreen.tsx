...
export default function PoultryScreen() {
  const { data: lots, loading, error, createLot } = useLots('volaille');
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        <View style={[styles.iconCircle, { backgroundColor: `${colors.accent}26` }]}>
          <Egg size={28} color={colors.accent} strokeWidth={2.5} />
        </View>
        <View>
          <Text style={styles.title}>Volailles</Text>
      ...
      >
        ...
        {lots.length === 0 ? (
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>Aucun lot de volailles</Text>
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, layout.shadows.cardLarge]}>
            <Text style={styles.modalTitle}>Nouveau lot de volailles</Text>

            <View style={styles.inputGroup}>
              <Text style={styles.inputLabel}>Nom du lot</Text>
              <TextInput
                style={styles.input}
                placeholder="Ex: Poulets Batch 1"
